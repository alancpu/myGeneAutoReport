...
public class CreateSummaryTableZhou {
	
	/*
	  public Tbl testDocx4jCreateTable() throws Exception {
		    boolean landscape = false;
		    WordprocessingMLPackage wordMLPackage = WordprocessingMLPackage
		        .createPackage(PageSizePaper.A4, landscape);
		    ObjectFactory factory = Context.getWmlObjectFactory();
		    setPageMargins(wordMLPackage, factory);
		    String imgFilePath = "C://20160624104215.png";
		    Tbl table = createTableWithContent(wordMLPackage, factory, imgFilePath);
		    return table;
		    //wordMLPackage.getMainDocumentPart().addObject(table);
		    //wordMLPackage.save(new java.io.File(System.getProperty("user.dir") + "/OUT_AddTable05.docx") );  
	}
	*/
		  public Tbl createTableWithContent(WordprocessingMLPackage wordMLPackage,
		    ...
		    defStyle.setBold(true);
		    defStyle.setItalic(false);
		    defStyle.setUnderline(false);
		    defStyle.setHorizAlignment(JcEnumeration.CENTER);
		    defStyle.setBackground("4f74a2");
		    defStyle.setFontColor("ffffff");
		    defStyle.setFontSize("30");
		    ...
		    addTableCell(factory, tableRow, "测试Field 1", 1600, defStyle, 1, null);
		    // start vertical merge for Filed 2 and Field 3 on 3 rows
		    addTableCell(factory, tableRow, "测试Field 2", 1600, defStyle, 1, null);
		    addTableCell(factory, tableRow, "测试Field 3", 1600, defStyle, 1, null);
		    addTableCell(factory, tableRow, "测试Field 3", 1600, defStyle, 1, null);
		    addTableCell(factory, tableRow, "测试Field 3", 1600, defStyle, 1, null);
		    addTableCell(factory, tableRow, "测试Field 3", 1600, defStyle, 1, null);
		    ...
		    P pImage;
		    try {
		      pImage = newImage(wordMLPackage, factory, bytes, filenameHint,altText, id1, id2, 800);
		      tableRow = factory.createTr();
		      addTableCell(factory, tableRow, pImage, 1600, defStyle, 1, null);
			  addTableCell(factory, tableRow, "测试Field 2", 1600, defStyle, 1, null);
			  addTableCell(factory, tableRow, "测试Field 3", 1600, defStyle, 1, null);
			  addTableCell(factory, tableRow, "测试Field 3", 1600, defStyle, 1, null);
			  addTableCell(factory, tableRow, "测试Field 3", 1600, defStyle, 1, null);
